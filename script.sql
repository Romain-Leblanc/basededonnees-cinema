...
INSERT INTO utilisateur (idUtilisateur, emailUtilisateur, motdepasseUtilisateur, nomUtilisateur, prenomUtilisateur, idRole) VALUES
    (1, "utilisateur@pathe-gaumont.com", MD5("MotDePasseDupontThomas"), "DUPONT", "Thomas", 1),
    (2, "utilisateur@cineville.com", MD5("MotDePasseDupontMartin"), "DUPONT", "Martin", 1),
    (3, "utilisateur@cgr.com", MD5("MotDePasseDupontLucas"), "DUPONT", "Lucas", 1),
    (4, "administrateur@cinema.com", MD5("MotDePasseAdmin123"), "Admin", "Admin", 2);
